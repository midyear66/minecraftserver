...
- **Mojang Account Verification** -- The proxy verifies player accounts against the Mojang API before forwarding connections. Banned players and invalid accounts are rejected at the proxy without waking sleeping servers.
