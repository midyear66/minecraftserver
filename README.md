...
- **Mojang Account Verification** -- The proxy verifies player accounts against the Mojang API before forwarding connections. Invalid accounts are rejected immediately without waking sleeping servers.
